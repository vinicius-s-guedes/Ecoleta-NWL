...
//buscar location expo install expo-location
...
const Points = ()=>{
	...
	useEffect(()=>{
		async function loadPosition(){
			...
			if(status !== 'granted'){//verifica se a permissçao de localização foi concedida
				Alert.alert('Opss','Precisamos da sua permissão para obter sua localização')
				return;
			}
